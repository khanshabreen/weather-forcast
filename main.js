            ...
            fetch(apiUrl)
              ...
              let currentDate = `${day}-${month}-${year}`;
                ...
                if (dataElement) {
                    ...
                    <p><b>${currentDate}</p></b>
                    <img src="./pcloudy.png" alt="clear"/></img>
                         <p>Transparency: <b>${transparency}</b></p>
                        <p>Wind Direction at 10m: <b>${wind10m_direction}</b></p>
                        <p>Wind Speed at 10m: <b>${wind10m_speed}</b></p>
                    ...
                    <p><b>${currentDate}</p></b>
                    <img src="./mcloudy.png" alt="clear"/></img>
                         <p>Transparency: <b>${transparency}</b></p>
                        <p>Wind Direction at 10m: <b>${wind10m_direction}</b></p>
                        <p>Wind Speed at 10m: <b>${wind10m_speed}</b></p>
                        <p>Temperature:<b> ${temp2m}ºC</b></p>
                    ...
                    <p><b>${currentDate}</p></b>
                    <img src="./cloudy.png" alt="clear"/></img>
                         <p>Transparency: <b>${transparency}</b></p>
                        <p>Wind Direction at 10m: <b>${wind10m_direction}</b></p>
                        <p>Wind Speed at 10m: <b>${wind10m_speed}</b></p>
                        <p>Temperature:<b> ${temp2m}ºC</b></p>
                    ...
                    <p><b>${currentDate}</p></b>
                    <img src="./rain.png" alt="clear"/></img>
                         <p>Transparency: <b>${transparency}</b></p>
                        <p>Wind Direction at 10m: <b>${wind10m_direction}</b></p>
                        <p>Wind Speed at 10m: <b>${wind10m_speed}</b></p>
                        <p>Temperature:<b> ${temp2m}ºC</b></p>
                    ...
                    <p><b>${currentDate}</p></b>
                    <img src="./oshower.png" alt="clear"/></img>
                         <p>Transparency: <b>${transparency}</b></p>
                        <p>Wind Direction at 10m: <b>${wind10m_direction}</b></p>
                        <p>Wind Speed at 10m: <b>${wind10m_speed}</b></p>
                        <p>Temperature:<b> ${temp2m}ºC</b></p>
                    ...
                    <p><b>${currentDate}</p></b>
                    <img src="./ishower.png" alt="clear"/></img>
                         <p>Transparency: <b>${transparency}</b></p>
                        <p>Wind Direction at 10m: <b>${wind10m_direction}</b></p>
                        <p>Wind Speed at 10m: <b>${wind10m_speed}</b></p>
                        <p>Temperature:<b> ${temp2m}ºC</b></p>
                    ...
                    <p><b>${currentDate}</p></b>
                    <img src="./snow.png" alt="clear"/></img>
                         <p>Transparency: <b>${transparency}</b></p>
                        <p>Wind Direction at 10m: <b>${wind10m_direction}</b></p>
                        <p>Wind Speed at 10m: <b>${wind10m_speed}</b></p>
                        <p>Temperature:<b> ${temp2m}ºC</b></p>
                    ...
                    <p><b>${currentDate}</p></b>
                    <img src="./rainsnow.png" alt="clear"/></img>
                         <p>Transparency: <b>${transparency}</b></p>
                        <p>Wind Direction at 10m: <b>${wind10m_direction}</b></p>
                        <p>Wind Speed at 10m: <b>${wind10m_speed}</b></p>
                        <p>Temperature:<b> ${temp2m}ºC</b></p>
                    ...
                    <p><b>${currentDate}</p></b>
                    <img src="./tsrain.png" alt="clear"/></img>
                         <p>Transparency: <b>${transparency}</b></p>
                        <p>Wind Direction at 10m: <b>${wind10m_direction}</b></p>
                        <p>Wind Speed at 10m: <b>${wind10m_speed}</b></p>
                        <p>Temperature:<b> ${temp2m}ºC</b></p>
                    ...
                    <p><b>${currentDate}</p></b>
                    <img src="./tstrom.png" alt="clear"/></img>
                         <p>Transparency: <b>${transparency}</b></p>
                        <p>Wind Direction at 10m: <b>${wind10m_direction}</b></p>
                        <p>Wind Speed at 10m: <b>${wind10m_speed}</b></p>
                        <p>Temperature:<b> ${temp2m}ºC</b></p>
                    ...
                    <p><b>${currentDate}</p></b>
                    <img src="./windy.png" alt="clear"/></img>
                         <p>Transparency: <b>${transparency}</b></p>
                        <p>Wind Direction at 10m: <b>${wind10m_direction}</b></p>
                        <p>Wind Speed at 10m: <b>${wind10m_speed}</b></p>
                        <p>Temperature:<b> ${temp2m}ºC</b></p>
